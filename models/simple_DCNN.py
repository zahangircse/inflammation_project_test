...
def Rec_conv2d_bn(x, nb_filter, nb_row, nb_col,
    ...
    x = tf.keras.layers.BatchNormalization(axis=bn_axis, name=bn_name)(x12)
...
def build_small_IRRCNN_v2(input_shape,nm_classes):
    ...
    x = conv2d_bn(x, 80, 1, 1, border_mode='valid')  
    x = conv2d_bn(x, 192, 3, 3, border_mode='valid')   # 28x28
...
def very_simple_DCNN(net_input_shape,num_classes):
